...
func TestEmbeddedDocumentationEndpoint(t *testing.T) {
	...
	if !strings.Contains(string(bodyChangelog), "Changelog") || !strings.Contains(string(bodyChangelog), "0.13.0") {
		t.Errorf("expected embedded CHANGELOG.md to contain 'Changelog' and '0.13.0', got %q", string(bodyChangelog))
	}
}
