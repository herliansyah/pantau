...
func TestEmbeddedDocumentationEndpoint(t *testing.T) {
	...
	if !strings.Contains(string(bodyChangelog), "Changelog") || !strings.Contains(string(bodyChangelog), "0.14.0") {
		t.Errorf("expected embedded CHANGELOG.md to contain 'Changelog' and '0.14.0', got %q", string(bodyChangelog))
	}
}
